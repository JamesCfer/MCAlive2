package dev.celestia.estari.util;
...
/** JSON helpers shared by the bridge and Bukkit-facing actuators. */
public final class Json {
    ...
    public static JsonObject reqObject(JsonObject o, String key) {
        JsonElement e = o.get(key);
        if (e == null || !e.isJsonObject()) throw new IllegalArgumentException("missing required object arg: " + key);
