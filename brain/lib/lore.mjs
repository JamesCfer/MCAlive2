// Loads brain/lore/*.md (sorted by filename) and concatenates them into the
// director's system prompt. Call watchLore() to re-read on a timer so edits
// to the lore files land without restarting the service (DESIGN.md: "lore
// hot-reloading from brain/lore/*.md").
