// Tracks cumulative daily token usage in brain/state/usage.json, resetting
// at UTC midnight. File-backed so a service restart mid-day doesn't quietly
// reset the budget. Shared by director and actor turns (one budget, per
// DESIGN.md's single "daily token budget" guardrail).
